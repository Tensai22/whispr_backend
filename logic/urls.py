...
from .views import login_view, register_view, logout_view, profile_update_view, password_change_view, password_reset_view, password_reset_confirm_view, SendMessageView, ReceivedMessagesView
